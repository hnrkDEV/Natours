...
},{}],"maplibre.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (location) {
    ...
    new maplibregl.Marker(el).setLngLat(location.coordinates).setPopup(new maplibregl.Popup({
      offset: 25
    }) // Add popups
    .setMaxWidth('25rem') // Set the max-width of the popup
    .setHTML("<div class='maplibregl-popup-content'><h4>".concat(location.description, "</h4><p>Day: ").concat(location.day, "</p></div>"))).addTo(map);
  });
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type, " Data updated successfully!"));
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51R8utMCLinbw94xQcXQKTj299y4rHeMiJSWintynX1fw41W00hYNKnz84OtiTCPcP7xNMrOWNtboSHPHO2xCpUXw00kDyl9W6Y');
...
var _maplibre = require("./maplibre");
...
if (mapBox) {
  ...
  (0, _maplibre.displayMap)(locations);
}
...
if (accountForm) {
  accountForm.addEventListener('submit', function (e) {
    ...
    var type = 'User';
    (0, _updateSettings.updateSettings)(form, type);
  });
}
;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            type = 'Password';
            _context.next = 7;
            return (0, _updateSettings.updateSettings)(data, type);
          case 7:
